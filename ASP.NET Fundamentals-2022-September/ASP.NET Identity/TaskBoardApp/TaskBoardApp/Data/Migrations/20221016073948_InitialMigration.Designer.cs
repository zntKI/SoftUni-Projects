...
namespace TaskBoardApp.Data.Migrations
{
    ...
    [Migration("20221016073948_InitialMigration")]
            ...
            modelBuilder.Entity("TaskBoardApp.Data.Entities.Task", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BoardId = 1,
                            CreatedOn = new DateTime(2022, 9, 16, 10, 39, 39, 612, DateTimeKind.Local).AddTicks(198),
                            Description = "Learn using ASP.NET Core Identity",
                            OwnerId = "9e52d31a-f28e-4626-9843-ddd2a4b6e78f",
                        ...
                        new
                        {
                            Id = 2,
                            BoardId = 3,
                            CreatedOn = new DateTime(2022, 5, 16, 10, 39, 39, 612, DateTimeKind.Local).AddTicks(248),
                        ...
                        new
                        {
                            Id = 3,
                            BoardId = 2,
                            CreatedOn = new DateTime(2022, 10, 6, 10, 39, 39, 612, DateTimeKind.Local).AddTicks(254),
                            Description = "Learn using ASP.NET Core Identity",
                            OwnerId = "9e52d31a-f28e-4626-9843-ddd2a4b6e78f",
                        ...
                        new
                        {
                            Id = 4,
                            BoardId = 3,
                            CreatedOn = new DateTime(2021, 10, 16, 10, 39, 39, 612, DateTimeKind.Local).AddTicks(258),
            ...
            modelBuilder.Entity("TaskBoardApp.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9e52d31a-f28e-4626-9843-ddd2a4b6e78f",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "04f7d69c-381b-4312-ba5a-f5ea0dba4227",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEF9EqQ11DSNhbJvI9RZs0KRkfY2OLHfxXlXG08QmDnHoa7llA+hh4VqMu8GPHUa6bA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "fad767d0-8534-4abd-8824-5c2dff70dfc5",
